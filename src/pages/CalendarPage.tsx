    ...
    <div className="flex-1 overflow-auto w-full">
      ...
      <div className="p-4 lg:p-6 space-y-4 lg:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-xl lg:text-2xl font-bold text-gray-900">Calendar & Tasks</h1>
            ...
            <CardContent className="p-4 lg:p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl lg:text-2xl font-bold text-gray-900">{todayTasks.length}</p>
                </div>
            ...
            <CardContent className="p-4 lg:p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl lg:text-2xl font-bold text-gray-900">{upcomingTasks.length}</p>
                </div>
          ...
          <Card>
            <CardContent className="p-4 lg:p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="p-2 lg:p-3 bg-emerald-50 rounded-full">
                ...
                <div className="grid grid-cols-7 gap-1">
                  ...
                  {Array.from({ length: 35 }, (_, i) => {
                    ...
                    return (
                      <div 
                        key={i} 
                        className={`p-1 sm:p-2 text-center text-xs sm:text-sm border rounded cursor-pointer hover:bg-gray-50 ${
